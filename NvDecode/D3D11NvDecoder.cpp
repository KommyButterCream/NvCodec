...
int32_t CUDAAPI D3D11NvDecoder::HandleVideoSequence(void* userData, CUVIDEOFORMAT* format)
{
	return reinterpret_cast<D3D11NvDecoder*>(userData)->OnVideoSequence(format);
}

int32_t CUDAAPI D3D11NvDecoder::HandlePictureDecode(void* userData, CUVIDPICPARAMS* pictureParams)
{
	return reinterpret_cast<D3D11NvDecoder*>(userData)->OnPictureDecode(pictureParams);
}

int32_t CUDAAPI D3D11NvDecoder::HandlePictureDisplay(void* userData, CUVIDPARSERDISPINFO* displayInfo)
{
	return reinterpret_cast<D3D11NvDecoder*>(userData)->OnPictureDisplay(displayInfo);
}

int32_t D3D11NvDecoder::OnVideoSequence(CUVIDEOFORMAT* videoFormat)
{
...
int32_t D3D11NvDecoder::OnPictureDecode(CUVIDPICPARAMS* pictureParams)
{
...
int32_t D3D11NvDecoder::OnPictureDisplay(CUVIDPARSERDISPINFO* displayInfo)
{
...
bool D3D11NvDecoder::InitializeCuda()
{
	// 디코더 생성을 위한 Cuda Driver 초기화
	// Cuda Context 생성/획득
	// Cuda Context 생성/획득
...
bool D3D11NvDecoder::ReconfigureDecoder(CUVIDEOFORMAT* videoFormat)
{
...
bool D3D11NvDecoder::CreateTexturePool()
{
...
void D3D11NvDecoder::DestroyTexturePool()
{
...
bool D3D11NvDecoder::CreateCudaDeviceMemoryPool()
{
...
void D3D11NvDecoder::DestroyCudaDeviceMemoryPool()
{
	// Cuda Device 메모리 해제
	for (int32_t i = 0; i < TEXTURE_POOL_COUNT; ++i)
	{
...
void D3D11NvDecoder::WaitForAllFrames()
{
...
bool D3D11NvDecoder::SaveFrameToBmp(int32_t index, const wchar_t* fileName)
{
...
bool D3D11NvDecoder::SaveNV12ToRawFile(CUdeviceptr srcFrame, unsigned int srcPitch, const wchar_t* fileName)
{
