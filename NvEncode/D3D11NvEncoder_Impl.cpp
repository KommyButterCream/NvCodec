...
void D3D11NvEncoder_Impl::DestoryAsyncEvent()
{
...
void D3D11NvEncoder_Impl::DestoryMappedInputBuffers()
{
	// Input Buffer 해제
...
void D3D11NvEncoder_Impl::DestoryBitstreamBuffers()
{
...
void D3D11NvEncoder_Impl::DestoryD3D11InputBuffers()
{
...
bool D3D11NvEncoder_Impl::InitializeOutputFrameBuffers()
{
...
void D3D11NvEncoder_Impl::DestroyOutputFrameBuffers()
{
...
void D3D11NvEncoder_Impl::ReleaseOutputFrameBuffer(NvEncOutputFrame& frame)
{
	// 프레임 데이터를 정리한다.
...
uint32_t D3D11NvEncoder_Impl::GetNextInputFrameIndex() const
{
	return WrapRingIndex(m_inputFrameIndex, m_encodeBufferCount);
}

uint32_t D3D11NvEncoder_Impl::GetNextOutputFrameIndex() const
{
	return WrapRingIndex(m_outputFrameIndex, m_encodeBufferCount);
}

bool D3D11NvEncoder_Impl::MapInputResources(uint32_t index)
{
...
bool D3D11NvEncoder_Impl::UnmapInputResources(uint32_t index)
{
